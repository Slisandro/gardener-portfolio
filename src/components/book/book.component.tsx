export default function BookComponent() {
    return (
        <div className="w-full flex flex-col-reverse lg:flex-row items-center justify-center bg-[#1B4332] min-h-160 text-white px-20 py-12 text-2xl gap-10 lg:gap-40 font-black">
            ...
            <div className="flex-1 flex items-center justify-center h-full lg:p-18">
                <img src="/book.jpg" className="h-100 lg:h-full object-cover rotate-8 hover:rotate-4 transition-transform duration-300 rounded-lg shadow-2xl" />
            </div>
        </div>
    )
}