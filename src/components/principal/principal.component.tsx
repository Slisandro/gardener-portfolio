export default function PrincipalComponent() {
  return (
    <div className="w-full h-120 md:h-160 p-4 md:p-8">
      <div
        className="w-full h-full rounded-4xl shadow-2xl px-4 md:px-8 py-12 flex flex-col justify-end gap-2 md:gap-8"
        style={{
      ...
      >
        ...
        <h2 className="font-black text-[2.5rem] sm:text-[4rem] md:text-[5rem] lg:text-[6rem] text-white leading-14 sm:leading-18 md:leading-24 lg:leading-26">
          Crafting Living <br className="hidden md:block" /> Masterpieces
        </h2>
